...
class HD{
	...
	public function getAddress($index){
		...
		$xpub = $key->derive($index);
		$pubkey = \phpEther\Tools\ECDSA::decompress_public_key($xpub->getPublicKey()->getHex());
		return \phpEther\Tools\ECDSA::public_key_to_address($pubkey);
	}
